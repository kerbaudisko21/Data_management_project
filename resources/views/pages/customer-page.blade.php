  ...
  <table class="table ">
    ...
    @foreach ($customers as $c)
        <tr>
            ...
            <td>{{$c->domisili}}</td>
            <td>
                <a href="/UpdateCustomer/{{$c->id}}"><button class="update">UPDATE</button></a>
                <a href="/Customer/delete/{{$c->id}}"><button class="delete">Delete</button></a>
              </td>
        </tr>
    @endforeach
  </table>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' action="/createCustomer" method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" style="height:40px">Buat Pelanggan</button>
            </div>
          </form>
